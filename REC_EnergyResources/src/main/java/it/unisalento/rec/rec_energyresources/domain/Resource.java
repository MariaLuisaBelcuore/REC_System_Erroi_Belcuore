package it.unisalento.rec.rec_energyresources.domain;
...
public class Resource {
    ...
    private int availableTimeOriginary;
    private float kWh;
    private String os;
    private int memory;
    ...
    public int getAvailableTimeOriginary() {return availableTimeOriginary;}

    public void setAvailableTimeOriginary(int availableTimeOriginary) {this.availableTimeOriginary = availableTimeOriginary;}
